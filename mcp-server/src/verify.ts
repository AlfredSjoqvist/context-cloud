...
type Args = { convexUrl: string | null; timeoutMs: number; help: boolean };

function parseArgs(argv: string[]): Args {
  const out: Args = { convexUrl: null, timeoutMs: 10_000, help: false };
...
Usage:
  hindsight-mcp-verify [--convex-url <url>] [--timeout <ms>]
