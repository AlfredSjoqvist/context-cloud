...
// ─── FILES ───────────────────────────────────────
const FILES = [
    "src/api/client.ts","src/api/auth.ts","src/api/webhooks.ts","src/api/types.ts",
    "src/components/Header.tsx","src/components/Dashboard.tsx","src/components/NoteCard.tsx",
    "src/components/FileTree.tsx","src/components/EdgeCanvas.tsx",
    "src/hooks/useNotes.ts","src/hooks/useFileGraph.ts","src/hooks/useGuardian.ts",
    "src/lib/convex.ts","src/lib/tensorlake.ts","src/lib/nia.ts","src/lib/mcp.ts",
    "src/utils/debounce.ts","src/utils/formatDate.ts",
    "src/agents/noteManager.ts","src/agents/gc.ts","src/agents/guardian.ts",
    ".env.example","package.json","tsconfig.json","README.md","TEST.md",
];
...
const ACTIVE_NOTES: ActiveNote[] = [
    { noteId:"n_92ac", importance:0.94, injectCount:47, ageMin:2*1440,
      ...
      edges:[{path:"src/api/client.ts",weight:1.0},{path:".env.example",weight:0.6}] },
    { noteId:"n_91d5", importance:0.71, injectCount:18, ageMin:4*1440,
      ...
      edges:[{path:"src/api/client.ts",weight:1.0},{path:".env.example",weight:0.55}] },
    { noteId:"n_4f1d", importance:0.88, injectCount:31, ageMin:5*1440,
      ...
      edges:[{path:"src/api/auth.ts",weight:1.0},{path:"src/lib/mcp.ts",weight:0.4}] },
    { noteId:"n_b73e", importance:0.82, injectCount:19, ageMin:1*1440,
      ...
      edges:[{path:"src/api/webhooks.ts",weight:1.0},{path:"src/lib/tensorlake.ts",weight:0.55}] },
    { noteId:"n_2c08", importance:0.79, injectCount:24, ageMin:3*1440,
      ...
      edges:[{path:"src/components/Dashboard.tsx",weight:1.0},{path:"src/hooks/useNotes.ts",weight:0.7},{path:"src/lib/convex.ts",weight:0.3}] },
    { noteId:"n_5a91", importance:0.76, injectCount:14, ageMin:8*1440,
      ...
      edges:[{path:"src/lib/convex.ts",weight:1.0}] },
    { noteId:"n_e6c4", importance:0.74, injectCount:11, ageMin:12*60,
      ...
      edges:[{path:"src/lib/tensorlake.ts",weight:1.0},{path:"src/agents/gc.ts",weight:0.5},{path:"src/agents/guardian.ts",weight:0.5}] },
    { noteId:"n_8d77", importance:0.71, injectCount:9, ageMin:4*1440,
      ...
      edges:[{path:"src/api/client.ts",weight:1.0},{path:"src/api/types.ts",weight:0.3}] },
    { noteId:"n_f330", importance:0.68, injectCount:8, ageMin:6*1440,
      ...
      edges:[{path:"tsconfig.json",weight:1.0},{path:"src/api/types.ts",weight:0.4}] },
    { noteId:"n_71b2", importance:0.64, injectCount:12, ageMin:2*1440,
      ...
      edges:[{path:"src/agents/guardian.ts",weight:1.0},{path:"src/hooks/useGuardian.ts",weight:0.7},{path:"src/lib/nia.ts",weight:0.4}] },
    { noteId:"n_c402", importance:0.61, injectCount:6, ageMin:1*1440,
      ...
      edges:[{path:"src/hooks/useNotes.ts",weight:1.0},{path:"src/components/NoteCard.tsx",weight:0.5}] },
    { noteId:"n_2f10", importance:0.52, injectCount:5, ageMin:7*1440,
      ...
      edges:[{path:"src/hooks/useNotes.ts",weight:1.0}] },
    { noteId:"n_a519", importance:0.58, injectCount:7, ageMin:11*1440,
      ...
      edges:[{path:"src/utils/formatDate.ts",weight:1.0},{path:"src/components/Dashboard.tsx",weight:0.35}] },
    { noteId:"n_d8e2", importance:0.55, injectCount:5, ageMin:3*1440,
      ...
      edges:[{path:"src/agents/noteManager.ts",weight:1.0},{path:"src/lib/mcp.ts",weight:0.6},{path:"src/lib/convex.ts",weight:0.4}] },
    ...
    { noteId:"n_03e1", importance:0.42, injectCount:4, ageMin:14*1440,
      ...
      edges:[{path:"src/api/client.ts",weight:0.6},{path:"src/api/types.ts",weight:0.6},{path:"package.json",weight:0.2}] },
    { noteId:"n_6a08", importance:0.38, injectCount:3, ageMin:20*1440,
      ...
      edges:[{path:"src/utils/debounce.ts",weight:1.0}] },
];
...
const LEGACY_HISTORY: HistoryNote[] = [
    { noteId:"n_old1", importance:0.18, injectCount:2, ageMin:32*1440,
      ...
      edges:[{path:"src/api/types.ts",weight:1.0}] },
    { noteId:"n_old2", importance:0.31, injectCount:5, ageMin:21*1440,
      ...
      edges:[{path:"src/api/webhooks.ts",weight:0.8}] },
    { noteId:"n_old3", importance:0.46, injectCount:7, ageMin:18*1440,
      ...
      edges:[{path:"src/api/client.ts",weight:0.9}] },
];
const EPHEMERAL_HISTORY: HistoryNote[] = [
    { noteId:"n_eph_01", importance:0.42, injectCount:5, ageMin:13*1440, lifecycleAtMin:8*1440,
      ...
      edges:[{path:"src/api/webhooks.ts",weight:0.6},{path:"src/agents/noteManager.ts",weight:0.4}] },
    { noteId:"n_eph_02", importance:0.51, injectCount:7, ageMin:12*1440, lifecycleAtMin:5*1440,
      ...
      edges:[{path:"src/api/client.ts",weight:0.85}] },
    { noteId:"n_eph_03", importance:0.39, injectCount:4, ageMin:11*1440, lifecycleAtMin:4*1440,
      ...
      edges:[{path:"src/components/Dashboard.tsx",weight:0.7}] },
    { noteId:"n_eph_04", importance:0.46, injectCount:6, ageMin:10*1440, lifecycleAtMin:6*1440,
      ...
      edges:[{path:"src/api/webhooks.ts",weight:0.9}] },
    { noteId:"n_eph_05", importance:0.34, injectCount:3, ageMin:9*1440, lifecycleAtMin:1*1440,
      ...
      edges:[{path:"src/lib/convex.ts",weight:0.55}] },
    { noteId:"n_eph_06", importance:0.48, injectCount:4, ageMin:9*1440, lifecycleAtMin:3*1440,
      ...
      edges:[{path:"src/components/Header.tsx",weight:0.8}] },
    { noteId:"n_eph_07", importance:0.43, injectCount:5, ageMin:7*1440, lifecycleAtMin:2*1440,
      ...
      edges:[{path:"src/lib/tensorlake.ts",weight:0.7}] },
    { noteId:"n_eph_08", importance:0.36, injectCount:2, ageMin:6*1440, lifecycleAtMin:90,
      ...
      edges:[{path:"src/utils/formatDate.ts",weight:0.5}] },
    { noteId:"n_eph_09", importance:0.40, injectCount:3, ageMin:5*1440, lifecycleAtMin:60,
      ...
      edges:[{path:"src/api/types.ts",weight:0.6},{path:"src/api/auth.ts",weight:0.3}] },
    { noteId:"n_eph_10", importance:0.45, injectCount:4, ageMin:4*1440, lifecycleAtMin:1440,
      ...
      edges:[{path:"src/components/NoteCard.tsx",weight:0.85},{path:"src/hooks/useNotes.ts",weight:0.4}] },
];

// ─── PRUNED EDGES (historical) ───────────────────
const PRUNED_EDGES = [
    { noteId:"n_92ac", path:"src/lib/mcp.ts",              weight:0.18, prunedOffsetMin:9*1440, reason:"edge weight 0.18 · never anchored an injection" },
    { noteId:"n_92ac", path:"src/agents/noteManager.ts",   weight:0.12, prunedOffsetMin:6*1440, reason:"edge weight 0.12 · 0 injections anchored to this file" },
    { noteId:"n_2c08", path:"src/utils/debounce.ts",       weight:0.09, prunedOffsetMin:5*1440, reason:"edge weight 0.09 below 0.10 threshold" },
    { noteId:"n_b73e", path:"src/lib/nia.ts",              weight:0.14, prunedOffsetMin:5*1440, reason:"unrelated file · stale anchor for 11d" },
    { noteId:"n_4f1d", path:"src/components/Header.tsx",   weight:0.07, prunedOffsetMin:4*1440, reason:"edge weight 0.07 · spurious match" },
    { noteId:"n_71b2", path:"src/utils/formatDate.ts",     weight:0.11, prunedOffsetMin:3*1440, reason:"edge weight 0.11 · file reorg in #519" },
    { noteId:"n_e6c4", path:"src/api/types.ts",            weight:0.13, prunedOffsetMin:3*1440, reason:"edge weight 0.13 · stale anchor" },
    { noteId:"n_d8e2", path:"src/components/EdgeCanvas.tsx", weight:0.06, prunedOffsetMin:2*1440, reason:"edge weight 0.06 · 0 injections in 7d" },
    { noteId:"n_5a91", path:"src/components/Dashboard.tsx", weight:0.16, prunedOffsetMin:2*1440, reason:"edge weight 0.16 · ADR-014 narrowed scope" },
    { noteId:"n_c402", path:"src/lib/convex.ts",           weight:0.10, prunedOffsetMin:1*1440, reason:"edge weight 0.10 below threshold" },
    { noteId:"n_8d77", path:"src/lib/mcp.ts",              weight:0.08, prunedOffsetMin:1*1440, reason:"edge weight 0.08 · never anchored" },
    { noteId:"n_a519", path:"src/api/types.ts",            weight:0.07, prunedOffsetMin:1*1440, reason:"edge weight 0.07 below threshold" },
];
